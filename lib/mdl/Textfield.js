...
class Textfield extends Component {
    ...
    _onInputMeasured(left, top, width, height) {
        ...
        this.refs.underline.updateLineLength(width + (this.props.inlineImageRight ? this.props.inlineImageRightSize : 0), () => {
    ...
    <View style={[{
        ...
        underlineColorAndroid="transparent"
            />
            {!this.props.inlineImageRight || (
        <Image
        resizeMode={'contain'}
        style={{
            width: this.props.inlineImageRightSize,
                height: this.props.inlineImageRightSize,
        }}
        source={this.props.inlineImageRight}
    />
    )}
    </View>
...
Textfield.propTypes = {
    ...
    // Image right
    inlineImageRight: PropTypes.any,

    // Image right width and height
    inlineImageRightSize: PropTypes.number
};
